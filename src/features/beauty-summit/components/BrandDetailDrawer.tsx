      ...
      >
        ...
        <div className="beauty-scroll min-h-0 flex-1 overflow-y-auto pr-1">
            ...
            <div className="flex min-w-0 items-start gap-3">
              {brand.logo || brand.link ? (
                <img
                  ...
                  alt={displayTitle}
                  className="bg-white h-16 w-16 shrink-0 rounded-[1rem] object-cover shadow-[0_10px_24px_rgba(0,0,0,0.22)]"
                />
              ) : (
                <div
              ...
              <div className="min-w-0">
                ...
                <div className="mt-1 text-[12px] font-medium text-white/80">Đã đồng bộ dữ liệu</div>
              </div>
            </div>
            <button
              type="button"
          ...
          <div className="mb-2 grid grid-cols-3 gap-3">
            <div className="rounded-[1rem] border border-white/10 px-3 py-3.5 text-center">
              <div className="text-lg font-black" style={{ color: category.color }}>
                {voteCount}
              </div>
              <div className="mt-1 text-[11px] text-white/70">Lượt vote</div>
            </div>
            <div className="rounded-[1rem] border border-white/10 px-3 py-3.5 text-center">
              <div className="text-lg font-black text-white">#{rank}</div>
              <div className="mt-1 text-[11px] text-white/70">Xếp hạng</div>
            </div>
            <div className="rounded-[1rem] border border-white/10 px-3 py-3.5 text-center">
              <div className="text-lg font-black text-[#ffd970]">{category.brands.length}</div>
              <div className="mt-1 text-[11px] text-white/70">Ứng viên</div>
            </div>
          </div>

          <div className="mb-5 rounded-[1.15rem] border border-white/10 p-4 shadow-[0_18px_34px_rgba(8,7,18,0.16)]">
            ...
            <div className="beauty-scroll max-h-[9.5rem] overflow-y-auto pr-1">
              <p className="whitespace-pre-wrap break-words text-sm leading-6 text-white/90">{summary}</p>
            </div>
