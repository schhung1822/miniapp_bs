...
export const BPOINT_VOUCHERS: Voucher[] = [
  {
    id: 'bp1',
    brand: 'Sulwhasoo',
    logo: 'S',
    discount: 'Giảm 30%',
    desc: 'Bộ dưỡng da First Care Activating Serum',
    cost: 30,
    code: 'BS26-SUL30',
    color: '#8B6914',
  },
  ...
  },
  {
    ...
    brand: 'MAC Cosmetics',
    logo: 'M',
    discount: 'Tặng son fullsize',
    desc: 'Lipstick Matte Chili hoặc Ruby Woo',
    cost: 100,
    code: 'BS26-MAC00',
    color: '#B5179E',
  },
  ...
  },
  {
    ...
    desc: 'Điều kiện bốc thăm xe VinFast VF3',
    cost: 999,
    code: null,
    color: '#C41E7F',
    isGrand: true,
...
export const FREE_VOUCHERS: Voucher[] = [
  {
    id: 'fv1',
    brand: 'La Roche-Posay',
    logo: 'LRP',
    discount: 'Tặng minisize',
  ...
  },
  {
    ...
    brand: "L'Oréal Paris",
    logo: 'LP',
    discount: 'Tặng túi canvas',
    desc: 'Nhận quà khi mua từ 500K',
    code: 'BS26-LOR00',
    color: '#1A1A1A',
  },
  {
    ...
    brand: "Kiehl's",
    logo: 'K',
    discount: 'Tặng sample kit',
    desc: 'Bộ 3 sample Ultra Facial Cream',
    code: 'BS26-KIE03',
    color: '#2C5F2D',
  },
];
